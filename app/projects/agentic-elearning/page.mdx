...
<ProjectPage>
  ...
  <ProjectSection title="Business outcomes" eyebrow="Impact">
    <ProjectOutcomes>
      <ProjectOutcome label="AI reliability" value="Structured outputs">
        JSON schemas and gateway validation keep agent responses predictable enough for product UI.
      </ProjectOutcome>
      <ProjectOutcome label="Grounding" value="RAG with citations">
        Lesson plans and quizzes are tied to retrieved sources rather than unconstrained generation.
      </ProjectOutcome>
      <ProjectOutcome label="Delivery model" value="Reference architecture">
        A reusable pattern for teams moving from Python AI prototypes to production services.
      </ProjectOutcome>
    </ProjectOutcomes>
  </ProjectSection>
