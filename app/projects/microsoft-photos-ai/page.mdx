...
<ProjectPage>
  ...
  >
    ...
    <ProjectServiceTags tags={['AI Product Integration', 'Cloud, Data & Reporting Architecture']} />
  </ProjectHero>

  <ProjectSection title="Business outcomes" eyebrow="Impact">
    <ProjectOutcomes>
      <ProjectOutcome label="Adoption" value="+20% MAU">
        Monthly active users increased by roughly 20% in the six months after the Editor AI launch.
      </ProjectOutcome>
      <ProjectOutcome label="Reach" value="Tens of millions">
        AI editing shipped inside the default Windows photo experience rather than as a niche add-on.
      </ProjectOutcome>
      <ProjectOutcome label="Product capability" value="Local + cloud AI">
        A reusable pattern for on-device inference with cloud fallback, telemetry, and rollout gates.
      </ProjectOutcome>
    </ProjectOutcomes>
  </ProjectSection>
