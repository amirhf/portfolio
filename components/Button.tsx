...
export default function Button({
  ...
  const base =
    'relative inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium transition focus-visible:ring-2 ring-brand/60 outline-none group'
  ...
  return (
    <button
      {...props}
      className={[base, variant === 'brand' ? brand : outline, className].join(' ')}
    >
